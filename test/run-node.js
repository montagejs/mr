...
// Execute
var mrRequire = require('../node');
var PATH = require("path");

// TODO: Not too sure why file:// is needed, maybe we can remove that restriction?
mrRequire.loadPackage("file://" + PATH.join(__dirname, ".")).then(function (mr) {
    return mr.async("all");
}).then(function () {
    console.log('Done');
